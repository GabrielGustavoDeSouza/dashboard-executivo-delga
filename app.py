...
st.markdown(f"""<div class="kpi-wrap" style="grid-template-columns:repeat(2,1fr);margin-top:-6px;">
  {kpi("ct",'<span style="font-size:13px;font-weight:800;">Valor potencial 2026</span>',fmt_mi(total_projetado_validado),
  ...
  {kpi("cg",'<span style="font-size:13px;font-weight:800;">Valor potencial ANUALIZADO</span>',fmt_mi(total_projetado_anual),
